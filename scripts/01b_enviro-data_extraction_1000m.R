...
#         Title: 01b environmental data extraction - 1000m
#         Project: OpenPrioBio
...
output_dir <- file.path(resultsfolder, "01b_enviro-extraction/1000m")

# list the occurrence dataframes
occurrence_list <- list.files(file.path(resultsfolder,
                                        "01a_occurrence-prep/1000m"), 
...
envdata_static_files <- 
  list.files(file.path(envdatafolder, "coregistration_2016_2024_1000m/static"), 
             full.names = TRUE, pattern = ".tif")

envdata_dynamic_files <- 
  list.files(file.path(envdatafolder, "coregistration_2016_2024_1000m/dynamic"), 
             full.names = TRUE, pattern = ".tif")
