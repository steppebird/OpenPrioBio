...
#==============================================================================#
####                        05a Export occurrence data                      ####
#==============================================================================#

### Export occurence data ###
# description: exports occurrence (presence-absence) data used in the models as
# shapefiles
# input: envdata (*.tif); pa_env (02b_spp.rds); gridsizes (sppgridsizes.csv); 
# occ_env (01b_spp_enviro.rds)
# output: occ-shp (05a_spp_occurrence.shp)

source("scripts/05a_shapefile-export.R")
